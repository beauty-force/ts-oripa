    ...
    <AppLayout>
        <div class="pt-6 md:px-6 px-4">  
            ...
            <form @submit.prevent="submit()">
                ...
                <div class="mb-4">
                    <label  for="dp" class="block font-medium text-sm text-neutral-700 mb-1">EP（半角数字）<span class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                    <label for="marks" class="block font-medium text-sm text-neutral-700 mb-1">残り（半角数字）<span class="text-red-500">*</span></label>
                    <input v-model="form.marks" id="marks" type="number" class="w-full border-neutral-300 focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-opacity-50 rounded-md shadow-sm"/>
                    <div v-if="errors.marks" class="text-red-500 text-sm mt-1">
                        {{ errors.marks }}
                    </div>
                </div>
                ...
                <div class="mb-4">
                    <label  for="text4" class="block font-medium text-sm text-neutral-700 mb-1">商品の状態</label>
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.form.post(route('admin.dp.store'));
        },  
        previewImage(e) {
