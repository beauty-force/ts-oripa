            ...
            <form @submit.prevent="submit" class="max-w-md mx-auto">
                ...
                <div v-if="step_integer==1" class="flex flex-col items-center">
                    <div class="mb-8 w-full">
                        ...
                        <div class="relative">
                            <input v-model="form.code" id="code" type="tel" class="w-full text-neutral-700 border-sky-300 focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50 rounded-xl shadow-sm px-4 py-3 transition-all duration-200" placeholder="SMSに記載された4桁の認証コード"/>
                ...
                <div v-if="step_integer==2" class="flex flex-col items-center">
                    ...
                    <div class="mb-6 w-full">
                        ...
                        <div class="relative">
                            <input v-model="form.email" id="email" type="email" class="w-full text-neutral-700 border-sky-300 focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50 rounded-xl shadow-sm px-4 py-3 transition-all duration-200" placeholder="例) user@トレしるオリパ.com"/>
...
<script>
    ...
    export default {
        components: { Checkbox, Head, AppLayout, InputError, TextInput, Link },
        data: () => ({
                        ...
                        onFinish: () => {
                            ...
                            if (this.data.data) {
                                if (this.data.data.status==1) {
                                    this.step_integer = 1;
                                    this.form.phone = this.data.data.phone;
                                }
                            }
